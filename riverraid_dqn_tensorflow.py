...
TRAIN_START = 500              # 샘플데이터가 몇개 쌓였을 때 Train을 시작할 지 정하는 변수
BATCH_SIZE = 32                  # 미니배치에서 사용할 배치사이즈 설정
TARGET_UPDATE_FREQUENCY = 150  # 몇 Frame 마다 Target 신경망을 업데이트 할 지 정하는 변수
...
EXPLORATION = 1500000            # Epsilon 시작부터 마지막 값까지 몇개의 step(time_step, frame, action)으로 줄여나갈 지 정하는 변수
