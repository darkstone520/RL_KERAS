    ...
    def _build_net(self):
        with tf.variable_scope(self.name):
            ...
            with tf.name_scope('conv_layer1') as scope:
                ...
                self.L1_sub = tf.nn.conv2d(input=X_img, filter=self.W1_sub, strides=[1, 1, 1, 1], padding='SAME')  # 32x32
                ...
                self.L2_sub = tf.nn.conv2d(input=self.L1_sub, filter=self.W2_sub, strides=[1, 1, 1, 1], padding='SAME')  # 32x32
                ...
                self.L3_sub = tf.nn.conv2d(input=self.L2_sub, filter=self.W3_sub, strides=[1, 1, 1, 1], padding='SAME')  # 32x32
            ...
            with tf.name_scope('conv_layer2') as scope:
                ...
                self.L2 = tf.nn.conv2d(input=self.L3_sub, filter=self.W2, strides=[1, 1, 1, 1], padding='SAME')  # 32x32
                ...
                # self.L2 = tf.nn.max_pool(value=self.L2, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')  # 32x32
            ...
            with tf.name_scope('conv_layer3') as scope:
                ...
                self.L3 = tf.nn.max_pool(value=self.L3, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')  # 32x32 -> 16x16
