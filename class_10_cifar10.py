...
RANDOM_MINI_BATCH_NO_ORDER = True # 중복허용
    ...
    while True:
        ...
        if (epoch >= START_EARLY_STOP_EPOCH) and float(np.mean(avg_cost_list)) < START_EARLY_STOP_COST:
            ...
            for i in range(test_total_batch_num):
                ...
                print(START_BATCH_INDEX, BATCH_SIZE)
                print(len(predictions[START_BATCH_INDEX-BATCH_SIZE:START_BATCH_INDEX,:]))
                print(len(test_y_batch[START_BATCH_INDEX-BATCH_SIZE:START_BATCH_INDEX,:]))
