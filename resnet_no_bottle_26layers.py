    ...
    def _build_net(self):
        with tf.variable_scope(self.name):
            ...
            with tf.name_scope('conv1'):
                ...
                self.W1_sub_0 = tf.get_variable(name='W1_sub_0', shape=[1,1,1,64], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                ...
                self.W1_sub_1 = tf.get_variable(name='W1_sub_1', shape=[1,7,64,64], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                ...
                self.W1_sub_2 = tf.get_variable(name='W1_sub_2', shape=[7,1,64,64], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
