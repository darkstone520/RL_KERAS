    ...
    def _build_net(self):
        with tf.variable_scope(self.name):
            ...
            with tf.name_scope('conv1'):
                ...
                self.L1_sub_0 = tf.nn.conv2d(input=X_img, filter=self.W1_sub_1, strides=[1,1,1,1], padding='SAME')
                ...
                self.L1_sub_1 = tf.nn.conv2d(input=L1_sub_0, filter=self.W1_sub_1, strides=[1,2,2,1], padding='SAME')
