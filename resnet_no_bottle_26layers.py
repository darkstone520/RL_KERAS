    ...
    def _build_net(self):
        with tf.variable_scope(self.name):
            ...
            with tf.name_scope('conv1'):
                ...
                # 7x7 -> 1x1, 1x3, 3x1, 1x3, 3x1, 1x3, 3x1
                # self.W1_sub_0 = tf.get_variable(name='W1_sub_0', shape=[1,1,1,8], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                # self.L1_sub_0 = tf.nn.conv2d(input=X_img, filter=self.W1_sub_0, strides=[1,2,2,1], padding='SAME')
                ...
                #
                # self.W1_sub_1 = tf.get_variable(name='W1_sub_1', shape=[3,1,8,8], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                ...
                #
                # self.W1_sub_2 = tf.get_variable(name='W1_sub_2', shape=[1,3,8,16], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                ...
                #
                # self.W1_sub_3 = tf.get_variable(name='W1_sub_3', shape=[3,1,16,16], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                ...
                #
                # self.W1_sub_4 = tf.get_variable(name='W1_sub_4', shape=[1,3,16,32], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                ...
                #
                # self.W1_sub_5 = tf.get_variable(name='W1_sub_5', shape=[3,1,32,32], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                ...
                #
                # self.W1_sub_6 = tf.get_variable(name='W1_sub_6', shape=[1,3,32,64], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
            ...
            with tf.name_scope('conv2_x'):
                ...
                # Pooling /2
                self.L2_sub = tf.nn.max_pool(value=self.L1_sub_2, ksize=[1,3,3,1], strides=[1,2,2,1], padding='SAME')
                ...
                self.L2_sub_6_r = self.parametric_relu(self.L2_sub_6 + self.L2_sub_2_r, 'R_conv2_6')
            ...
            with tf.name_scope('conv3_x'):
                ...
                ####################################################################################################
                # 2-1
                self.L3_sub_1 = tf.nn.conv2d(input=self.L2_sub_6_r, filter=self.W3_sub, strides=[1,2,2,1], padding='SAME')
                ...
                input_x = tf.layers.conv2d(inputs=self.L2_sub_6_r, kernel_size=(1,1), strides=(2,2), padding='SAME', filters=128)
            ...
            with tf.name_scope('conv4_x'):
                ...
                ####################################################################################################
                # 2-1
                self.L4_sub_1 = tf.nn.conv2d(input=self.L3_sub_6_r, filter=self.W4_sub, strides=[1,2,2,1], padding='SAME')
                ...
                input_x = tf.layers.conv2d(self.L3_sub_6_r, kernel_size=(1,1), strides=(2,2), filters=256, padding='SAME')
            ...
            with tf.name_scope('conv5_x'):
                ...
                ####################################################################################################
                # 2-1
                self.L5_sub_1 = tf.nn.conv2d(input=self.L4_sub_6_r, filter=self.W5_sub, strides=[1,2,2,1], padding='SAME')
                ...
                input_x = tf.layers.conv2d(self.L4_sub_6_r, kernel_size=(1,1), strides=(2,2), filters=512, padding='SAME')
                ...
                self.L5_sub_3_r = self.parametric_relu(self.L5_sub_3, 'R_conv5_3')
