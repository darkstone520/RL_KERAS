    ...
    def _build_net(self):
        with tf.variable_scope(self.name):
            ...
            with tf.name_scope('conv2_x'):
                ...
                self.bottle_neck_in_in = tf.get_variable(name='bnk_2_in_in', shape=[1,1,128,32], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
                ...
                self.bottle_neck_out = tf.get_variable(name='bnk_2_out', shape=[1,1,32,128], dtype=tf.float32, initializer=tf.contrib.layers.variance_scaling_initializer())
            ...
            with tf.name_scope('conv4_x'):
                ...
                input_x = tf.layers.conv2d(inputs=self.L3_sub_12_r, kernel_size=(1, 1), strides=(2, 2), padding='SAME', filters=512)
            ...
            with tf.name_scope('conv5_x'):
                ...
                input_x = tf.layers.conv2d(inputs=self.L4_sub_18_r, kernel_size=(1, 1), strides=(2, 2), padding='SAME', filters=1024)
